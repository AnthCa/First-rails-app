...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { description: @publication.description, price: @publication.price, title: @publication.title } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { description: @publication.description, price: @publication.price, title: @publication.title } }
